...
// evolution of the wave packet.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CevolutionofthewavepacketApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CevolutionofthewavepacketApp

CevolutionofthewavepacketApp::CevolutionofthewavepacketApp()
{
...
// Единственный объект CevolutionofthewavepacketApp

CevolutionofthewavepacketApp theApp;


// Инициализация CevolutionofthewavepacketApp

BOOL CevolutionofthewavepacketApp::InitInstance()
{
